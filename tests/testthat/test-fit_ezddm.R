...
test_that("fit_ezddm works as intended", {
  library(rtdists)
  data1 <- rdiffusion(n = 100, a = runif(1, 0, 3), v = runif(1, -5, 5), t0 = runif(1, 0.1, 0.7), z = runif(1, 0.01, 0.99) * 2) # simulate data
  data2 <- rdiffusion(n = 100, a = runif(1, 0, 3), v = runif(1, -5, 5), t0 = runif(1, 0.1, 0.7), z = runif(1, 0.01, 0.99) * 2) # simulate data
